...
import mne
from openmiir.preprocessing.pipeline import load_raw, load_ica
from openmiir.preprocessing.events import generate_beat_events
from mneext.resample import fast_resample_mne, resample_mne_events
